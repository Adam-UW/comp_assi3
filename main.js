...
function Circle(game) {
    ...
    this.radius = 12;
    this.current = game;
    this.colors = ["yellow", "Red", "violet", "Blue", "White", "Pink", "Orange"];
...
function StillCircle(game) {
    this.player = 1;
    this.radius = 12;
    this.colors = ["purple", "Red", "violet", "Blue", "White", "Pink", "Orange"];
    this.color = Math.floor(Math.random() *10 + 1);
    this.tag = "white";
    this.count = 50;
    Entity.call(this, game, this.radius + Math.random() * (800 - this.radius * 2), this.radius + Math.random() * (800 - this.radius * 2));
...
window.onload = function () {
    ...
    saveButton.onclick = function () {
      ...
      console.log(entity);
      socket.emit("save", { studentname: "Adam Shandi", statename: "Assignment3", data: entity });
    };
  
    loadButton.onclick = function () {
      console.log("load");
      text.innerHTML = "Loaded."
      socket.emit("load", { studentname: "Adam Shandi", statename: "Assignment3" });
    };
